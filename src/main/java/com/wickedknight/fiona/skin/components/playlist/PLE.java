...
public class PLE extends ActiveDraggable {
    ...
    private static final Rectangle[] area = { new Rectangle(14, 20, 240, 14), new Rectangle(14, 33, 240, 14),
            new Rectangle(14, 46, 240, 14), new Rectangle(14, 59, 240, 14) };
    private static final Rectangle[] source = { new Rectangle(0, 0, 25, 20), new Rectangle(127, 0, 25, 20),
            new Rectangle(153, 0, 25, 20), new Rectangle(0, 42, 25, 29), new Rectangle(26, 42, 25, 29),
            new Rectangle(0, 72, 125, 38), new Rectangle(0, 42, 25, 38), new Rectangle(126, 72, 150, 38) };
    private static final Rectangle[][] unshaded = {
            { new Rectangle(0, 149, 22, 18), new Rectangle(0, 130, 22, 18), new Rectangle(0, 111, 22, 18) },
            { new Rectangle(54, 149, 22, 18), new Rectangle(54, 130, 22, 18), new Rectangle(54, 111, 22, 18),
                    new Rectangle(54, 168, 22, 18) },
            { new Rectangle(104, 149, 22, 18), new Rectangle(104, 130, 22, 18), new Rectangle(104, 111, 22, 18) },
            { new Rectangle(154, 149, 22, 18), new Rectangle(154, 130, 22, 18), new Rectangle(154, 111, 22, 18) },
            { new Rectangle(204, 149, 22, 18), new Rectangle(204, 130, 22, 18), new Rectangle(204, 111, 22, 18) } };
    private static final Rectangle[][] shaded = {
            { new Rectangle(23, 149, 22, 18), new Rectangle(23, 130, 22, 18), new Rectangle(23, 111, 22, 18) },
            { new Rectangle(77, 149, 22, 18), new Rectangle(77, 130, 22, 18), new Rectangle(77, 111, 22, 18),
                    new Rectangle(77, 168, 22, 18) },
            { new Rectangle(127, 149, 22, 18), new Rectangle(127, 130, 22, 18), new Rectangle(127, 111, 22, 18) },
            { new Rectangle(177, 149, 22, 18), new Rectangle(177, 130, 22, 18), new Rectangle(177, 111, 22, 18) },
            { new Rectangle(227, 149, 22, 18), new Rectangle(227, 130, 22, 18), new Rectangle(227, 111, 22, 18) } };
    private static final Rectangle[] bar = { new Rectangle(48, 111, 3, 54), new Rectangle(100, 111, 3, 72),
            new Rectangle(150, 111, 3, 54), new Rectangle(200, 111, 3, 54), new Rectangle(250, 111, 3, 54) };
    private static final Rectangle[] barArea = { new Rectangle(11, 50, 3, 54), new Rectangle(40, 32, 3, 72),
            new Rectangle(69, 50, 3, 54), new Rectangle(98, 50, 3, 54), new Rectangle(228, 50, 3, 54) };
    ...
    private static final Rectangle[][] buttonArea = {
            { buttonAreaR1, new Rectangle(14, 68, 22, 18), new Rectangle(14, 50, 22, 18) },
            { new Rectangle(43, 86, 22, 18), new Rectangle(43, 68, 22, 18), new Rectangle(43, 50, 22, 18),
                    new Rectangle(43, 32, 22, 18) },
            { new Rectangle(72, 86, 22, 18), new Rectangle(72, 68, 22, 18), new Rectangle(72, 50, 22, 18) },
            { new Rectangle(101, 86, 22, 18), new Rectangle(101, 68, 22, 18), new Rectangle(101, 50, 22, 18) },
            { new Rectangle(231, 86, 22, 18), new Rectangle(231, 68, 22, 18), new Rectangle(231, 50, 22, 18) } };
    ...
    Rectangle[] destpanel = { new Rectangle(0, 0, 25, 20), new Rectangle(25, 0, 25, 20), new Rectangle(0, 20, 25, 29),
            new Rectangle(0, 0, 125, 38), new Rectangle(0, 0, 150, 38) };
    ...
    public PLE(Skin paramSkin) {
        ...
        this.boundary = new Rectangle(0, 0, paramSkin.getMainPanel().getWidth(null),
                paramSkin.getMainPanel().getHeight(null));
    }
    ...
    private Color parseColor(String paramString) throws Exception {
