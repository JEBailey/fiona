...
public class Config
{
  ...
  private void init()
  {
    File localFile = new File(home, ".fiona");
  ...
  private void createConfig(File paramFile)
    throws Exception
  {
    this.props.put("url", "");
  ...
  private void loadConfig(File paramFile)
    throws Exception
  {
 ...
 * Qualified Name:     com.wickedknight.fiona.configure.Config
