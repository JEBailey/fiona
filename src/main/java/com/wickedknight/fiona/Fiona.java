...
public class Fiona extends JFrame implements FionaEventListener, WindowListener, KeyListener {
    /**
     * 
     */
    ...
    private static String TITLETEXT = "Fiona Fiona 0.8";

    public static void main(String[] paramArrayOfString) {
        new Fiona(TITLETEXT);
    }
    
    public Fiona(String paramString) {
        super(paramString);
        init();
    }
 ...
 * com.wickedknight.fiona.Fiona JD-Core Version: 0.6.2
 */